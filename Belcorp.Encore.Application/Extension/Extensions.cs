    ...
    public static class Extensions
    {
        ...
        public static List<ReportAccountExcel_DTO> ToReportAccountExcel_DTO(this List<AccountsInformation_MongoWithAccountAndSponsor> list)
        {
            var result = list.Select(ai => new ReportAccountExcel_DTO()
            {
                ...
                PCV = ai.PCV,
                AccountPhone_1 = ai.Account != null ? ai.Account.AccountPhones.Where(p => p.AccountPhoneID == 1).Select(p => p.PhoneNumber).FirstOrDefault() : "",
                AccountPhone_2 = ai.Account != null ? ai.Account.AccountPhones.Where(p => p.AccountPhoneID == 2).Select(p => p.PhoneNumber).FirstOrDefault() : "",
                AccountPhone_3 = ai.Account != null ? ai.Account.AccountPhones.Where(p => p.AccountPhoneID == 3).Select(p => p.PhoneNumber).FirstOrDefault() : "",
                AccountPhone_4 = ai.Account != null ? ai.Account.AccountPhones.Where(p => p.AccountPhoneID == 4).Select(p => p.PhoneNumber).FirstOrDefault() : "",
                AccountPhone_5 = ai.Account != null ? ai.Account.AccountPhones.Where(p => p.AccountPhoneID == 5).Select(p => p.PhoneNumber).FirstOrDefault() : "",
                AccountPhone_6 = ai.Account != null ? ai.Account.AccountPhones.Where(p => p.AccountPhoneID == 6).Select(p => p.PhoneNumber).FirstOrDefault() : "",
                AccountPhone_7 = ai.Account != null ? ai.Account.AccountPhones.Where(p => p.AccountPhoneID == 7).Select(p => p.PhoneNumber).FirstOrDefault() : "",
                PQV = ai.PQV,
                SponsorEmailAddress = ai.Sponsor != null ? ai.Sponsor.EmailAddress : "",
                SponsorID = ai.SponsorID,
